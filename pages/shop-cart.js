...
const Cart = ({
    ...
    const price = () => {
        let price = 0;
        cartItems.forEach((item) => (price += item.price * item.quantity * item.group));
        return price;
    };

    return (
        <>
            <Layout parent="الصفحة الرئيسية" sub="المتجر" subChild="العربة">
                <section className="mt-50 mb-50" dir="rtl">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 mb-40">
                                <h1 className="heading-2 mb-10">عربتك</h1>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="table-responsive shopping-summery">
                                    {cartItems.length <= 0 && "لا توجد منتجات"}
                                    <table
                                        className={
                                            cartItems.length > 0
                                    ...
                                    >
                                        ...
                                        <tbody>
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    >
                                                        <h4 className="text-body">
                                                            {item.quantity * item.price* item.group} ج.م
                                                        </h4>
                                                    </td>
                                                    <td
                                                        className="action"
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-right" data-title="الإجمالي">
                                                    <h4 className="text-body">
                                                        {price()} ج.م
                                                    </h4>
                                                </td>
                                ...
                                {cartItems.length > 0 &&
                                    <a className="btn " href="/userinfo">
                                        <i className="fi-rs-shopping-bag ml-10"></i>
                                        شراء
                                    </a>
                                    }
                                </div>

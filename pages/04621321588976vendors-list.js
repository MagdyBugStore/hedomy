                                        ...
                                        <div className="vendor-wrap mb-40  style-2">
                                            ...
                                            <div className="vendor-content-wrap">
                                                <div className="mb-30">
                                                    ...
                                                    <h4 className="mb-5"><Link href={`vendor/${item._id}`}><a>{item.title}</a></Link></h4>
                                                    ...
                                                    <div className="vendor-info d-flex justify-content-between align-items-end mt-30">
                                                        ...
                                                        <Link href={`vendor/${item._id}`}><a className="btn btn-xs">Visit Store <i className="fi-rs-arrow-small-right"></i></a></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

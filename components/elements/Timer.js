        ...
        <>
            <div className="deals-countdown pl-5">
                <span className="countdown-section">
                    ...
                    <span className="countdown-period"> أيام </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.hours}
                    </span>
                    <span className="countdown-period"> ساعات </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.minutes}
                    </span>
                    <span className="countdown-period"> دقائق </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.seconds}
                    </span>
                    <span className="countdown-period"> ثواني </span>
                </span>
            </div>
        </>
    );
